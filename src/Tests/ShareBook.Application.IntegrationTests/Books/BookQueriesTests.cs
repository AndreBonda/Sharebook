...
public class BookQueriesTests
{
    ...
    public async Task OneTimeSetUp()
    {
        ...
        {
                    Book.New("OwnerX", "TitleX", "AuthorX", 2, new string[] {"LabelX"}),
                    Book.New("OwnerY", "TitleY", "AuthorY", 2, new string[] {"LabelY"}),
                    Book.New("OwnerZ", "TitleZ", "AuthorZ", 2, new string[] {"LabelZ"})
        });
