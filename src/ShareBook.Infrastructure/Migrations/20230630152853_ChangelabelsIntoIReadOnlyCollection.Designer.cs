...
namespace ShareBook.Infrastructure.Migrations
{
    ...
    [Migration("20230630152853_ChangelabelsIntoIReadOnlyCollection")]
    partial class ChangelabelsIntoIReadOnlyCollection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShareBook.Domain.Books.Book", b =>
                {
                    b.HasOne("ShareBook.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("ShareBook.Domain.Books.LoanRequest", "CurrentLoanRequest", b1 =>
                        {
                            ...
                            b1.Property<Guid>("RequestingUserId")
                                .HasColumnType("uuid")
                                .HasColumnName("current_loan_request_requesting_user_id");
